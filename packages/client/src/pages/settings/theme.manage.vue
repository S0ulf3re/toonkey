...
<div class="_formRoot">
	...
	<template v-if="selectedTheme">
		...
		<FormButton v-if="!builtinThemes.some(t => t.id == selectedTheme.id)" class="_formBlock" danger @click="uninstall()"><i class="ph ph-trash-bold"></i> {{ i18n.ts.uninstall }}</FormButton>
	</template>
</div>
</template>
