...
<div class="dkgtipfy" :class="{ wallpaper }">
	...
	<div v-if="isMobile" class="buttons">
		...
		<button class="button home _button" @click="$route.name === 'index' ? top() : $router.push('/')"><i class="ti ti-home-2"></i></button>
		<button class="button notifications _button" @click="$router.push('/my/notifications')"><i class="ti ti-bell-ringing-2"></i><span v-if="$i?.hasUnreadNotification" class="indicator"><i class="fas fa-circle"></i></span></button>
