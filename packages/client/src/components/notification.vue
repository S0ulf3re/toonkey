...
<div ref="elRef" v-size="{ max: [500, 600] }" class="qglefbjs" :class="notification.type">
	<div class="head">
		...
		<div class="sub-icon" :class="notification.type">
			<i v-if="notification.type === 'follow'" class="ph ph-plus-bold"></i>
			...
			<i v-else-if="notification.type === 'renote'" class="ph ph-repeat-bold"></i>
			<i v-else-if="notification.type === 'reply'" class="ph ph-arrow-bend-up-left-bold"></i>
			<i v-else-if="notification.type === 'mention'" class="ph ph-at-bold"></i>
