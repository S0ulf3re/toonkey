...
<div class="vjoppmmu">
	<template v-if="edit">
		<header>
			...
			<MkButton inline primary class="mk-widget-add" @click="addWidget"><i class="ph ph-plus-bold"></i> {{ $ts.add }}</MkButton>
		...
		>
			<template #item="{element}">
				<div class="customize-container">
					...
					<button class="remove _button" @click.prevent.stop="removeWidget(element)"><i class="ph ph-x-bold"></i></button>
